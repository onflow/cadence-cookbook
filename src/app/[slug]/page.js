...
import { fetchExternalRecipe, getAllRecipes, getNextRecipe, getPreviousRecipe, getRelatedRecipes, getSingleModuleByTitle, getSingleRecipe } from "src/data/recipeUtils";
...
export default async function RecipePage({params}) {
  ...
  return <SingleRecipeView moduleSlug={fetchedModule.slug} recipe={fetchedRecipe} relatedRecipes={relatedRecipes} nextRecipeTitle={nextRecipe !== null ? nextRecipe.title : null} nextRecipeSlug={nextRecipe !== null ? nextRecipe.slug : null} previousRecipeSlug={previousRecipe !== null ? previousRecipe.slug : null} />;
}
