...
function FungibleTokenSwitchboard() {
  ...
  return (
    ...
    >
      ...
      <div className="text-left pl-4">
        ...
        <div>
          {/* This is where the description of the FungibleTokenSwitchboard resource will go */}
...
export default FungibleTokenSwitchboard;
