...
import AddFungibleTokenSwitchboardResource from './Add_FungibleTokenSwitchboard_Resource';
import AddNewVaultToSwitchboard from './Add_New_Vault_To_Switchboard';
import AddNewVaultsToSwitchboard from './Add_New_Vaults_To_Switchboard';
import addNewVaultWrapperToSwitchboard from './Add_New_Vault_Wrapper_To_Switchboard';
...
export default [
    ...
    AddFungibleTokenSwitchboardResource,
    AddNewVaultToSwitchboard,
    AddNewVaultsToSwitchboard,
    addNewVaultWrapperToSwitchboard,
];
